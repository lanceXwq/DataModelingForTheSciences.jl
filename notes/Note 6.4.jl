...
md"""
# Note 6.4: The squared exponential kernel
"""
...
# ╔═╡ ff761cab-2552-48c8-9bb6-123fd034b3c8
μ = zeros(length(x));

# ╔═╡ 15ccc11a-84d5-43be-866d-3da3a4cc1ba6
λ = 0.1;

# ╔═╡ 69ae72a0-5d0f-483f-95a6-69db8b680a7d
l = 0.2;

# ╔═╡ 5d17dad0-9af6-4df1-a089-2a8bf3296984
C = PSDMat(get_kernel(x, λ, l))

# ╔═╡ 5c8c4388-3b98-42ea-bcbe-50c201e677de
distr = MvNormal(μ, C);

# ╔═╡ 4a8cacad-7d7e-426d-9999-9610e3b0874a
f = rand(distr);

# ╔═╡ c9e2d998-a92c-446a-a74e-6880b9467507
lines(x, f)
